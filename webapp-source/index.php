...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>  
		...
		<?php	
			...
			print('<script src="https://maps.googleapis.com/maps/api/js?sensor=false"></script>' . "\n"); // v3
		?>

		<?php # <script src="javascript/ClusterMarker.js" type="text/javascript"></script> // v2 ?>
		<script src="javascript/markerclusterer.js" type="text/javascript"></script>  <!-- v3 -->
		<script src="javascript/infobubble.js" type="text/javascript"></script> <!-- v3 -->
